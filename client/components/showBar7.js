...
class ShowBar7 extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
    ...
    async selectArea(name) {
        document.getElementById("disdfd").innerHTML=name
    ...
    renderBar(barDataTotal,format,max,length){
        console.log("数据："+max);
        max = 1;
        let Bar = echarts.init(document.getElementById('bar7'));
        let yData_deploy = []
        let barData  = []
        let barDatatwo = []
        ...
        var optionss = {
            ...
            xAxis : [
                {
                    type : 'category',
                    data : ['2018年11月', '2018年12月', '2019年1月', '2019年2月', '2019年3月', '2019年4月'],
                    axisTick: {
                        alignWithLabel: true,
                        color:'#fff'
                    },
            ...
            series : [
                {
                    ...
                    data:[{name:"2018年11月",value:0.8,itemStyle:{
                        normal:{color:'#fff'}
                    }},{name:"2018年12月",value:0.93,itemStyle:{
                        normal:{color:'#fff'}
                    }},{name:"2019年1月",value:0.78,itemStyle:{
                        normal:{color:'#fff'}
                    }},{name:"2019年2月",value:0.83,itemStyle:{
                        normal:{color:'#fff'}
                    }},{name:"2019年3月",value:0.8,itemStyle:{
                        normal:{color:'#fff'}
                    }},{name:"2019年4月",value:0.98,itemStyle:{
                        normal:{color:'#fff'}
                    }}]
                }
            ]
        ...
        return(
            <div className={css(styles.container)}>
                ...
                <div className={css(styles.showDiv)}>
                    <div className={css(styles.tubiao)} id='bar7' style={{width:'418px',height:'190px'}}></div>
                </div>
            </div>
        )
    }
