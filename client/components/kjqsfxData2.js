...
class KjqsfxData2 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            JRRWS: true,
        ...
        return (
            <div className={css(styles.container)}>
                <div className={css(styles.upPart)}>
                    <div className={css(styles.title)}>所属国合格率</div>
                ...
                <ReactEcharts className={css(styles.leftBrokenLine)} option={this.kjqsfxData2Brokenline()} />
                {/*                 <div className={css(styles.leftBrokenLine)} id='kjqsfxData2Brokenline'>
                </div> */}
                <ReactEcharts className={css(styles.rightCake)} option={this.kjqsfxData2Cake()} />
                {/*                 <div className={css(styles.rightCake)} id='kjqsfxData2Cake'></div> */}
                <div className={css(styles.rightContent)}>
                    <div className={css(styles.zsTitle)}>合格总数</div>
                    <div className={css(styles.numdata)}>387,636</div>
                </div>
            </div>
        )
    }
