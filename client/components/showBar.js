...
class ShowBar extends React.Component{
    ...
    renderBar(barDataTotal,format,max,length){
        ...
        //京五里店98.7%、京开发区98.9%、京东郊站99.0%、京关关税99.1%、机场货管99.2%
        barData = [{name:"京五里店",value:0.008,itemStyle:{
            normal:{color:'#40A9ED'}
        }},{name:"京开发区",value:0.009,itemStyle:{
            normal:{color:'#40A9ED'}
        }},{name:"京东郊站",value:0.01,itemStyle:{
            normal:{color:'#40A9ED'}
        }},{name:"京关保税",value:0.011,itemStyle:{
            normal:{color:'#40A9ED'}
        }},{name:"机场货管",value:0.013,itemStyle:{
            normal:{color:'#40A9ED'}
        }}]
        barDatatwo = [{name:"机场货管",value:80},{name:"京监管处",value:75},{name:"京关展览",value:70},{name:"京关保税",value:65},{name:"京涉外处",value:59}]
        yData_deploy = ["京五里店","京开发区","京东郊站","京关保税","机场货管"]
    ...
    render(){
        ...
        return(
            <div className={css(styles.container)}>
                <div className={css(styles.header)} >{/*{this.props.barName}*/}隶属关当月不合格率排名</div>
                {/*{spanArr}*/}
                <div className={css(styles.showDiv)}>
                    <div className={css(styles.tubiao)} id='bar' style={{width:'335px',height:'180px'}}></div>
                </div>
            </div>
        )
    }
