    ...
    render() {
        return (
            <div className={css(styles.container)}>
                ...
                <ReactEcharts className={css(styles.leftBrokenLine)} option={this.kjqsfxData3Brokenline()} />
  {/*               <div className={css(styles.leftBrokenLine)} id='kjqsfxData3Brokenline'>
                </div> */}
                 <ReactEcharts className={css(styles.rightCake)} option={this.kjqsfxData3Cake()} />
